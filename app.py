...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div style="text-align: justify;">
          This application developed by 4th year students of ENSA Marrakech
           performs sentiment analysis on the latest 
          tweets based on the entered search term. 
          Since the application can only predict positive or negative sentiment, 
          it is more suitable for analyzing the sentiment of a brand, product, service, 
          company, or person. Only English tweets are supported. 
